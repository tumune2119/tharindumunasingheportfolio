...
export default function Home() {
  return (
    ...
    >
      ...
      {/* Scroll-down summaries: most visitors scroll before they click a nav
          link, so Experience/Projects/Articles/Contact each get a preview
          right on the landing page (still linking out to their own full
          page) instead of only being reachable through the nav. */}
      <div className="relative z-10 mt-16 flex flex-col gap-4 sm:mt-20 sm:gap-6 md:mt-24">
        <Reveal>
          <ExperiencePreview />
        </Reveal>
        <Reveal delay={80}>
